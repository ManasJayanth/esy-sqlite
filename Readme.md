[![Build and test the esy package](https://github.com/ManasJayanth/esy-sqlite/actions/workflows/workflow.yml/badge.svg)](https://github.com/ManasJayanth/esy-sqlite/actions/workflows/workflow.yml)
# esy-sqlite
...
## How to use `esy-sqlite`?

`esy-sqlite` can be used from both NPM and directly from Github.

### From NPM 

`esy-sqlite` is deployed on NPM can be found
[here](https://www.npmjs.com/package/TODO).

You can simply run `esy add esy-sqlite` to install it, or specify it in
...
{
  "dependencies": {
    "esy-sqlite": "esy-packages/esy-sqlite"
  }
}
```
...
```diff
  "dependencies": {
+   "esy-sqlite": "esy-packages/esy-sqlite#<commit hash>"
  }
```
